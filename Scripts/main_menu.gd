...
@export var leaderboard_button: Button # زر لوحة الصدارة
...
@export_file("*.tscn") var leaderboard_scene_path: String = "res://Scenes/leaderboard.tscn" # مسار لوحة الصدارة
...
func _ready() -> void:
	...
	if leaderboard_button: leaderboard_button.pressed.connect(_on_leaderboard_pressed) # ربط زر اللوحة
